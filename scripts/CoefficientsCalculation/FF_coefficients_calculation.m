...
run('C:\Users\Michal\Documents\GitHub\symulacja-lotu\ComputationalTools\Dispersion_analysis\Grot Dispersion\DispersionAnalysis_Grot3_FF_Drawsko_Pomorskie.m');
% plot from this script is demanded to add on it landing points from 3)

% 2) get coordinates of the biggest ellipse
% done in past (by saving data with usage of breakpoints in GetEllipses.m
% function in Functions folder for post-processing script), saved as .mat
% file
load('FF_ellipsecoo.mat');
...
coord_front = [53.517834*pi/180, 15.978642*pi/180];
coord_back = [53.384073*pi/180, 15.706108*pi/180];
coord_side = [53.535831*pi/180, 15.732385*pi/180];
coord_no_wind = [53.454590*pi/180, 15.849284*pi/180];
apogee_front = 26495.998483;
apogee_back = 27931.233168;
apogee_side = 27180.996271;
apogee_no_wind = 27959.271969;
...
% factors calculation
factor_landing_points = min(distances_interp./distances_to_all_LP);

apogees_all = [apogee_front, apogee_back, apogee_side, apogee_no_wind];
factor_altitude = (average3 + 3*standard_deviation3)/max(apogees_all);