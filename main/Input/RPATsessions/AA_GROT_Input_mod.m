function [Fuel_Input, Grain_Struct, Engine_Parameters, Ambient_Input, Simulation_Settings] = AA_GROT_Input_mod()

Fuel_Input.propellant_name = "GROT-fuel";              %Name of the propellant
Fuel_Input.propellant_density = 1769;        	        %Propellant density [kg/m^3]
Fuel_Input.temperature_combustion = 3300;     	        %Combustion temperature [K]
Fuel_Input.kappa = 1.15;                                %Heat Capacity Ratio [-]
Fuel_Input.molar_mass = 27.20;                          %Molar mass of combustion products [g/mol]
Fuel_Input.burn_coefficient = 5.7;                      %Temperature coefficient [mm/s]
Fuel_Input.burn_expo = 0.34;                            %Burn rate exponent [-]
...
Fuel_Input.dynamic_viscosity = 0.96789 * 10^-4;			%Dynamic viscocity [Pa*s]
Fuel_Input.conductivity = 0.25523;                      %Heat conductivity of gas [W/m/K]
Fuel_Input.C_p = 2343.5;                %Fuel_Input.gas_constant * Fuel_Input.kappa / (Fuel_Input.kappa - 1); 	%Gas heat capacity [J/kg/K]
Fuel_Input.Pr = 0.19724;                %Fuel_Input.dynamic_viscosity * Fuel_Input.C_p / Fuel_Input.conductivity; 		%Prandtl's number [-]
...
Fuel_Input.beta = 130;                  %erosive constant [-]
Fuel_Input.Ts = 2000; 					%temperature of propellant's surface [K]

grain_number = 1;
Grain_Struct(grain_number).x_grain_base_wrt_nozzle_inlet = 0.0035;
Grain_Struct(grain_number).Grain_stl_filename = 'main/Output/tt.stl';
...
Simulation_Settings.time_step = 0.01;                %Time step for calculations [s]	CHANGED
Simulation_Settings.solver_type = 'euler';
Simulation_Settings.time_max = 4.5;                     %Simulation time [s]
